  ...
  export default {
    ...
    methods: {
      ...
      getEquipmentTableData(data1,data2) {
        axios.post(" " + URL + "/app/Electricity/yearlyElectricityTableData", {"startYear": data1,"endYear":data2})
          .then((res) => {
            if (res.data.state === "1") {
      ...
      getEquipmentLineData(data1,data2) {
        axios.post(" " + URL + "/app/Electricity/yearlyElectricityLineData",  {"startYear": data1,"endYear":data2})
          .then((res) => {
            if (res.data.state === "1") {
              if (res.data.data.length > 0) {
      ...
      doSearch() {
        if (this.startMonth && this.endMonth) {
          let that = this;
          axios.all([
            axios.post(" " + URL + "/app/Electricity/yearlyElectricityTableData", {"startYear": this.startYear,"endYear":this.endYear}),
            axios.post(" " + URL + "/app/Electricity/yearlyElectricityLineData", {"startYear": this.startYear,"endYear":this.endYear})
          ])
